...
<?php if ($total_records > 0): ?>
  ...
  <form action="page_delete_result2.php" method="post" style="display: inline-block;">
    <input type="hidden" name="cust_no" value="<?php echo $_POST["cust_no"] ?>">
    <input type="submit" name="submit_delete" value="是">
  </form>
  <form action="page_delete_result2.php" method="post" style="display: inline-block;">
    <input type="hidden" name="cust_no" value="<?php echo $_POST["cust_no"] ?>">
    <input type="submit" name="cancel_delete" value="否">
  </form>
<?php else: ?>
  <p>
